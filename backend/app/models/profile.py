...
from sqlalchemy import Column, ForeignKey, Integer, String  # Existing imports...
from sqlalchemy import UUID  # <--- ADD THIS LINE HERE, INSIDE THE FILE
from app.models.base import BaseModel, SoftDeleteMixin
...
class Skill(BaseModel, SoftDeleteMixin):
    ...
    proficiency_level = Column(
        SQLEnum(ProficiencyLevel), default=ProficiencyLevel.INTERMEDIATE
    )
